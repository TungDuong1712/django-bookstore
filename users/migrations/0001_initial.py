    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='users/avatars/', verbose_name='Ảnh đại diện')),
                ('bio', models.TextField(blank=True, verbose_name='Tiểu sử')),
                ('user_type', models.CharField(choices=[('customer', 'Khách hàng'), ('staff', 'Nhân viên'), ('admin', 'Quản trị viên')], default='customer', max_length=10, verbose_name='Loại người dùng')),
